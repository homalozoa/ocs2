...
class QuadrupedInterface : public ocs2::RobotInterface {
 public:
  ...
  std::shared_ptr<SwitchedModelModeScheduleManager> getSwitchedModelModeScheduleManagerPtr() const { return mode_scheduleManagerPtr_; }

  /** Gets the mode schedule manager */
  std::shared_ptr<ocs2::ReferenceManagerInterface> getReferenceManagerPtr() const override { return mode_scheduleManagerPtr_; }
 ...
 private:
  ...
  std::shared_ptr<SwitchedModelModeScheduleManager> mode_scheduleManagerPtr_;
