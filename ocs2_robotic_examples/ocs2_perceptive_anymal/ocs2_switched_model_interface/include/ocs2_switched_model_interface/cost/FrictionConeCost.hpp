...
class FrictionConeCost final : public ocs2::StateInputCost {
 public:
  FrictionConeCost(friction_cone::Config config, const SwitchedModelModeScheduleManager& mode_scheduleManager,
 ...
 private:
  ...
  const SwitchedModelModeScheduleManager* mode_scheduleManager_;
