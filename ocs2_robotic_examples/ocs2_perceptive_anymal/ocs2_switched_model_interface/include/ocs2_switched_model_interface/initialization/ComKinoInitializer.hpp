...
class ComKinoInitializer : public ocs2::Initializer {
 public:
  ...
  ComKinoInitializer(const com_model_t& comModel, const SwitchedModelModeScheduleManager& mode_scheduleManager);
 ...
 private:
  ...
  const SwitchedModelModeScheduleManager* mode_scheduleManagerPtr_;
};
